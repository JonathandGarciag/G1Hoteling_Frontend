...
import { useGenerateBill } from '../../shared/hooks/useGenerateBill';

import { buscarReservacionesPorHotel } from '../../service/reservacionService';

import '../../style/GenerateFactura.css'
...
const GenerarFacturaForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!userId) {
        throw new Error('No se encontró el ID del usuario para la reservación seleccionada');
      }
