    ...
    >
      ...
      <ul className="menu modern-menu">
        {user?.role === "CLIENT_ROLE" && (
          <>
            <li onClick={() => navigate("hotelView")}><FaHotel /><span>Hoteles</span></li>
            <li onClick={() => navigate("/hotel/:hotelId/eventos")}><FaCalendarAlt /><span>Eventos</span></li>
            <li onClick={() => navigate("/mis-reservas")}><FaHistory /><span>Reservaciones</span></li>
            <li onClick={() => navigate("/myProfile")}><FaCog /><span>Mi cuenta</span></li>
          </>
        )}
